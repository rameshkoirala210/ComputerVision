...
class RequirementTracker:
    ...
    def add(self, req: InstallRequirement) -> None:
        ...
        assert req.link
        # Get the files to write information about this requirement.
        entry_path = self._entry_path(req.link)

        # Try reading from the files. If it exists and can be read from, a build
    ...
    def remove(self, req: InstallRequirement) -> None:
        ...
        assert req.link
        # Delete the created files and the corresponding entries.
