...
class InstallRequirement:
    ...
    def hashes(self, trust_internet: bool = True) -> Hashes:
        ...
        Hashes in URLs--ones embedded in the requirements files, not ones
    ...
    def archive(self, build_dir: Optional[str]) -> None:
        ...
        if os.path.exists(archive_path):
            response = ask_path_exists(
                'The files {} exists. (i)gnore, (w)ipe, '
    ...
    def install(
        ...
        # the setup.py call with the ones from the requirements files.
        # Options specified in requirements files override those
