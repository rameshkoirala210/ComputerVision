...
#
# We set sys.argv[0] to the path to the underlying setup.py files so
# setuptools / distutils don't take the path to the setup.py to be "-c" when
# invoking via the shim.  This avoids e.g. the following manifest_maker
# warning: "warning: manifest_maker: standard files '-c' not found".
_SETUPTOOLS_SHIM = (
...
def make_setuptools_shim_args(
    ...
    # type: (...) -> List[str]
    """
    Get setuptools command arguments with shim wrapped setup files invocation.
