...
def adjacent_tmp_file(path: str, **kwargs: Any) -> Iterator[BinaryIO]:
    """Return a files-like object pointing to a tmp files next to path.

    The files is created securely and is ensured to be written to disk
    after the context reaches its end.

    kwargs will be passed to tempfile.NamedTemporaryFile to control
    the way the temporary files will be opened.
    """
