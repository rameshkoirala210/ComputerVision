...
class RequirementsFileParseError(InstallationError):
    """Raised when a general error occurs parsing a requirements files line."""
...
class DirectoryUrlHashUnsupported(HashError):
    ...
    order = 1
    head = ("Can't verify hashes for these files:// requirements because they "
...
class HashMissing(HashError):
    ...
    def body(self):
        ...
        if self.req:
            ...
            # seen in the requirements files rather than the package name,
            # so the output can be directly copied into the requirements files.
...
class HashMismatch(HashError):
    """
    Distribution files hash values don't match.
...
class ConfigurationFileCouldNotBeLoaded(ConfigurationError):
    """When there are errors while loading a configuration files
    """
    ...
    def __str__(self):
        ...
        if self.fname is not None:
            ...
            message_part = f".\n{self.error}\n"
        return f"Configuration files {self.reason}{message_part}"
