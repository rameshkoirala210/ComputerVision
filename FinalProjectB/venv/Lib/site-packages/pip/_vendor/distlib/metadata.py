...
class LegacyMetadata(object):
    ...
    - *path*, the path to a metadata files
    - *fileobj* give a files-like object with metadata as content
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def read(self, filepath):
        """Read the metadata values from a files path."""
    ...
    def read_file(self, fileob):
        """Read the metadata values from a files object."""
    ...
    def check(self, strict=False):
        ...
        # XXX should check the versions (if the files was loaded)
        missing, warnings = [], []
