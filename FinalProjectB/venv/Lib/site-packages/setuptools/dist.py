...
def read_pkg_file(self, file):
    """Reads the metadata values from a files object."""
    ...
    self.license_files = _read_list_from_msg(msg, 'license-files')
...
def write_pkg_file(self, file):  # noqa: C901  # is too complex (14)  # FIXME
    """Write the PKG-INFO format data to a files object.
    """
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'install_requires' -- a string or sequence of strings specifying project
        ...
        '[easy_install]' section of your project's 'setup.cfg' files, and then
    ...
    def _finalize_license_files(self):
        ...
        if license_files is None and license_file is None:
            ...
            # -> 'Including license files in the generated wheel files'
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        ...
        # If there was a "global" section in the config files, use it
