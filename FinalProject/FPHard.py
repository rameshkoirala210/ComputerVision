...
# whatever you want" I decided to use calcHist to calculate and normalize the frequency by multiplying it by 512 * 512
histblue = (cv2.calcHist([blue], [0], None, [256], [0, 256])) / (512 * 512)
histgreen = (cv2.calcHist([green], [0], None, [256], [0, 256])) / (512 * 512)
histred = (cv2.calcHist([red], [0], None, [256], [0, 256])) / (512 * 512)
